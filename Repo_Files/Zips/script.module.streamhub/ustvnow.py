...
username = "samclarke1231@gmail.com"
password = "Escort123"
free_or_all = "free"                                                                                           ###
...
def Ustvnow(free_or_all = "free"):
    ...
    payload = {'username': username, 'password': password, 'device':'gtv', 'redir':'0'}
    ...
    try:
        soup = BeautifulSoup.beautify(html,"lxml")
    except:
        soup = BeautifulSoup.beautify(html,"html.parser")
