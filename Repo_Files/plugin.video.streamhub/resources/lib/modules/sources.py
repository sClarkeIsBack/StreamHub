...
class sources:
        ...
        for i in range(0, (timeout * 2) + 60):
            try:
                ...
                try:
                    ...
                    pass
                try:
                    string4 = "We are searching multiple scrapers and gathering links for: [COLOR red][B]%s (%s)[/COLOR][/B] - Time Elapsed: [COLOR ghostwhite]%s Seconds[/COLOR]"  % (title,year,str(timerange))
                    string5 = ''
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.streamhub.container.items'

        self.metaProperty = 'plugin.video.streamhub.container.meta'
