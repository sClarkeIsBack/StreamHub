...
class CloudflareBypass(Session):
...
create_scraper = CloudflareBypass.create_scraper
get_tokens = CloudflareBypass.get_tokens
get_cookie_string = CloudflareBypass.get_cookie_string
