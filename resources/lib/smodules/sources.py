...
class sources:
    ...
    def play(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select):
        try:
            ...
            from resources.lib.smodules.player import player
    ...
    def getConstants(self):
        ...
        from resources.lib.ssources import sources as sources
        from resources.lib.ssources_de import sources as sources_de
